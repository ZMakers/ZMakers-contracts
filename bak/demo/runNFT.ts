...
function createCollectionData() {
    let functionSig = web3.eth.abi.encodeFunctionSignature('createCollection(string)')
    console.log(functionSig)
    let parameters = web3.eth.abi.encodeParameters(['string'], ['https://example.com'])
    console.log(parameters)
    let data = functionSig + parameters.substring(2);
